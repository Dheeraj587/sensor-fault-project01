...
class PredictionPipeline:
    ...
    def predict(self,features):
        try:
            model = self.utlis.load_object(self.prediction_pipeline_config.model_file_path)
            preprocessor = self.utlis.load_object(file_path=self.prediction_pipeline_config.preprocessor_path)
